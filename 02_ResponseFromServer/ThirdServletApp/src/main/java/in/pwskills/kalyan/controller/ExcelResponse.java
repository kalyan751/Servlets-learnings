...
@WebServlet(description = "Response of video type form the server to the client", urlPatterns = { "/excelData" })
public class ExcelResponse extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String path = getServletContext().getRealPath("sampleExcel.xls");
